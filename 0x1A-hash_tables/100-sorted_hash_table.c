 ...
 * @size: The new sorted hash table size.
...
/**
 * shash_table_get - function that retrieves the sorted hash table key value.
 * @ht: sorted hash table pointer.
 * @key: The key value.
 ...
 * @ht: sorted hash table  pointer to print.
 */
